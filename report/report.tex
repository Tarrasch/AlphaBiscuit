...
biscuits.
The final classifier reach a near-perfect result on the training data
when using cross-validation, however it doesn't perfectly classify
biscuits in a clean 'word-image', perhaps rendering the classifier inadequate.
...
Where $\wedge$ stands for logical conjuction. r, g and b stands for red, green and blue, respectively.
