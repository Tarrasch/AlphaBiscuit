...
p = [...
%%% BEGIN ENTRIES %%%
     '~/Bildanalys/AlphaBiscuit/src_mat:', ...
     '~/Bildanalys/AlphaBiscuit/src_mat/io:', ...
     '~/Bildanalys/AlphaBiscuit/src_mat/filter:', ...
     '~/Bildanalys/AlphaBiscuit/src_mat/features:', ...
     '~/Bildanalys/AlphaBiscuit/src_mat/wording:', ...
     '~/Bildanalys/AlphaBiscuit/src_mat/classify:', ...
     '/chalmers/users/rarash/matlab:', ...
